  ...
  return (
    <div className="main">
      ...
      <canvas
        ...
        height={mobile ? window.innerHeight / 2 : window.innerHeight / 1.5}
      />
      <div className={mobile ? "controls_mobile" : "controls"}>
        <div className="reverse_container">
          <input
            className={reverseButton ? "selected" : ""}
            id="reverse"
            type="image"
            src={reverse_button}
            alt="reverse"
        ...
        <img
          src={playButton ? play_button : pause_button}
          alt="play"
          onClick={async () => {
            if (playing.current) {
        ...
        <div className="speed_container">
          <button
            ...
            onClick={(e) => {
              speed.current =
                speeds[(speeds.indexOf(speed.current) + 1) % speeds.length];
